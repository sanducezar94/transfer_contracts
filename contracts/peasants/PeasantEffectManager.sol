...
abstract contract PeasantEffectManager is Ownable {
  ...
  function _getPeasantAttributes(
    uint256
  ) internal view virtual returns (IPeasants.PeasantStats memory attributes);
  ...
  function getPeasantEffect(
    ...
    IPeasants.PeasantStats memory attributes = _getPeasantAttributes(tokenId);
